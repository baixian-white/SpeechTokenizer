...
def checkpoint_num_steps(checkpoint_path):
    """
    根据 ckpt 文件名中的数字推断步数，例如 .../something.20000.pt -> 20000
    """
...
class SpeechTokenizerTrainer(nn.Module):
    ...
    def train(self):
        ...
        for disc in self.discriminators.values():  # 显式 train()，避免 map 的惰性
            disc.train()
        step_time_log = {}
        ...
        if steps < self.num_warmup_steps:
            ...
            lr = self.scheduler_g.get_last_lr()[0]  # 仅读取，真正的 step 在累积边界进行
