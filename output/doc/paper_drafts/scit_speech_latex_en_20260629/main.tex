...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.95\linewidth]{figures/fig1_system_overview.pdf}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.95\linewidth]{figures/fig2_rate_quality_tradeoff.pdf}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.95\linewidth]{figures/fig5_perturbation_robustness.pdf}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.95\linewidth]{figures/fig7_three_user_router_architecture.png}
...
\section{Appendix: Accounting and Protocol Details}
...
\section{Appendix: Additional Same-rate Baselines}
