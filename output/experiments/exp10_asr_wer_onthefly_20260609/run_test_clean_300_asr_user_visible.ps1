...
'USER_VISIBLE_ASR_TEST_CLEAN_300_STARTED ' + (Get-Date) | Set-Content 'H:\H-CODE\speechtokenizer\output\experiments\exp10_asr_wer_onthefly_20260609\logs\user_visible_test_clean_300_marker.txt'
Start-Transcript -Path 'H:\H-CODE\speechtokenizer\output\experiments\exp10_asr_wer_onthefly_20260609\logs\test-clean_300_asr_user_visible_transcript.log' -Append
Write-Host '=== SCIT ASR/WER test-clean 300, user-visible PowerShell ==='
...
& 'C:\Users\Windows11\.conda\envs\speechtokenizer\python.exe' scripts/evaluate_asr_wer_onthefly.py `
  --run-dir output/experiments/exp10_asr_wer_onthefly_20260609/eval_asr_wer_clean/test-clean_300 `
