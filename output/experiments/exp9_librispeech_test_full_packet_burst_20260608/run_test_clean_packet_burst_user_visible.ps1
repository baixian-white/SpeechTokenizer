...
'USER_VISIBLE_PACKET_BURST_TEST_CLEAN_STARTED ' + (Get-Date) | Set-Content 'H:\H-CODE\speechtokenizer\output\experiments\exp9_librispeech_test_full_packet_burst_20260608\logs\user_visible_test_clean_marker.txt'
Start-Transcript -Path 'H:\H-CODE\speechtokenizer\output\experiments\exp9_librispeech_test_full_packet_burst_20260608\logs\test-clean_packet_burst_user_visible_transcript.log' -Append
Write-Host '=== SCIT packet/burst test-clean, user-visible PowerShell ==='
...
& 'C:\Users\Windows11\.conda\envs\speechtokenizer\python.exe' scripts/evaluate_packet_burst_large_nosave.py `
  --run-dir output/experiments/exp9_librispeech_test_full_packet_burst_20260608/eval_packet_burst_full_lca_nosave/test-clean `
