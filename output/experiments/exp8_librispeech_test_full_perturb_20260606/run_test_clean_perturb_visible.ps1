...
Write-Host 'Activate conda env: speechtokenizer'
& 'C:\Users\Windows11\.conda\Scripts\conda.exe' activate speechtokenizer
Write-Host ('Started at: ' + (Get-Date))
python scripts/evaluate_perturb_large_nosave.py `
  ...
  --save-sample-count 5 `
  --device cuda 2>&1 | Tee-Object -FilePath output/experiments/exp8_librispeech_test_full_perturb_20260606/logs/test-clean_perturb_full.log
