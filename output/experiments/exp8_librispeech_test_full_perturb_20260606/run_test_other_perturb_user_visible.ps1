...
'USER_VISIBLE_TEST_OTHER_STARTED ' + (Get-Date) | Set-Content 'H:\H-CODE\speechtokenizer\output\experiments\exp8_librispeech_test_full_perturb_20260606\logs\user_visible_test_other_marker.txt'
Start-Transcript -Path 'H:\H-CODE\speechtokenizer\output\experiments\exp8_librispeech_test_full_perturb_20260606\logs\test-other_perturb_user_visible_transcript.log' -Append
Write-Host '=== SCIT perturb test-other, user-visible PowerShell ==='
...
& 'C:\Users\Windows11\.conda\envs\speechtokenizer\python.exe' scripts/evaluate_perturb_large_nosave.py `
  --run-dir output/experiments/exp8_librispeech_test_full_perturb_20260606/eval_perturb_full_lca_nosave/test-other `
