...
'USER_VISIBLE_PERT_ASR_TEST_OTHER_100_STARTED ' + (Get-Date) | Set-Content 'H:\H-CODE\speechtokenizer\output\experiments\exp11_perturbed_asr_wer_20260609\logs\user_visible_test_other_100_marker.txt'
Start-Transcript -Path 'H:\H-CODE\speechtokenizer\output\experiments\exp11_perturbed_asr_wer_20260609\logs\test-other_100_perturbed_asr_user_visible_transcript.log' -Append
Write-Host '=== SCIT perturbed ASR/WER test-other 100 ==='
...
& 'C:\Users\Windows11\.conda\envs\speechtokenizer\python.exe' scripts/evaluate_perturbed_asr_wer_onthefly.py `
  --run-dir output/experiments/exp11_perturbed_asr_wer_20260609/eval_perturbed_asr_wer/test-other_100 `
